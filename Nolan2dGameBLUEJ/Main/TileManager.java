...
public class TileManager {
    ...
    System.out.println("loaded grass");
            ...
            tile[1] = new tile();
            tile[1].image = ImageIO.read(getClass().getClassLoader().getResourceAsStream("res/tiles/dirt.png"));
            ...
            tile[3] = new tile();
            tile[3].image = ImageIO.read(getClass().getClassLoader().getResourceAsStream("res/tiles/sand.png"));
            System.out.println("loaded sand");
            tile[4] = new tile();
            URL url = getClass().getClassLoader().getResource("res/tiles/tree.png");
if (url != null) {
    ...
    System.out.println("res/tree.png not found");
}
            ...
            tile[5] = new tile();
            tile[5].image = ImageIO.read(getClass().getClassLoader().getResourceAsStream("res/tiles/wall.png"));
